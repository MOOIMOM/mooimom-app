...
class EventRegistrationScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      banners: [{ path: Images.momsClassBanner1 }, { path: Images.momsClassBanner2 }],
      activeSlide: 0,
  ...
  _renderImage({ item, index }, parallaxProps) {
    image = item.path
    return (
      <FastImage source={image} style={{ width: '100%', height: 200 }} resizeMode={FastImage.resizeMode.contain} />
    );
  }
    ...
    return (
      <View style={{ width: '94%', alignSelf: 'center', marginTop: 30 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <Text style={{ fontFamily: Fonts.type.gotham2, color: Colors.black, fontSize: Metrics.fontSize1 }}>Saturday - 7 March 2020</Text>
        </View>
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontFamily: Fonts.type.gotham1, color: Colors.mooimom, fontSize: Metrics.fontSize1, marginBottom: 10 }}>Time</Text>
          <Text style={{ fontFamily: Fonts.type.gotham2, color: Colors.black, fontSize: Metrics.fontSize1 }}>4 session (11.00-12.00 & 13:00-14:00) (Obgyn), (15.00-16.00 & 17.00-18.00) (Pediatrician)</Text>
        </View>
        <View style={{ marginBottom: 20 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <Text style={{ fontFamily: Fonts.type.gotham2, color: Colors.black, fontSize: Metrics.fontSize1 }}>22 February - 6 March 2020</Text>
        </View>
        <View style={{ marginBottom: 20 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontFamily: Fonts.type.gotham2, color: Colors.black, fontSize: Metrics.fontSize1 }}>Segera daftarkan diri Moms melalui nomor WhatsApp berikut ya Moms +62 812-8844-6533</Text>
        </View>

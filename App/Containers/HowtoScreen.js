...
import { ScrollView, Text, View, Image, TouchableOpacity, AsyncStorage } from 'react-native'
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottom}>
          <View style={styles.bottom3}>
            <Text style={styles.gotoText} onPress={() => this.skipLearn()}>Skip</Text>
          </View>
          <View style={styles.bottom3}>
            <Pagination
          ...
          <View style={styles.bottom3}>
            {this.state.activeSlide === this.state.learnpages.length - 1 && <Text style={styles.gotoText} onPress={() => this.pressContinue()}>Lanjut</Text>}
          </View>
        </View>
      </View >
    )

...
const { Types, Creators } = createActions({
  ...
  editProfilePictureRequest: ['data'],
  editProfileSuccess: ['payload'],
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.EDIT_PROFILE_PICTURE_REQUEST]: request,
  [Types.EDIT_PROFILE_SUCCESS]: success,
  [Types.EDIT_PROFILE_FAILURE]: failure,
})

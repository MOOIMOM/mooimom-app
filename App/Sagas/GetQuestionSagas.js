...
export function* postGetQuestion(api, action) {
  const { data } = action
  ...
  if (response.data.success === 1) {
    ...
    yield put(GetQuestionActions.getQuestionFailure(err))
  }
    ...
    yield put(GetQuestionActions.getQuestionFailure(response.data))
  }
}
